                           ...
                           god_type god, int piety)
{
    ...
    if (best_skill < NUM_SKILLS)
    {
        ...
        case SK_MACES_FLAILS:
            if (species == SP_STAR && skill_rank == 5)
        ...
        case SK_INVOCATIONS:
            if (species == SP_DEMONSPAWN && skill_rank == 5 && is_evil_god(god))
                ...
                result = "Rockslime";
            else if (species == SP_STAR && skill_rank == 5 && god == GOD_ZIN)
                result = "Silver Star"; // removed dc6d6fabc (0.15), ha!
            else if (species == SP_STAR && skill_rank == 5 && god == GOD_DITHMENOS)
        ...
        case SK_BOWS:
            ...
            else if (species == SP_STAR && skill_rank == 5)
