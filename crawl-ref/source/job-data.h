...
{ JOB_ARTIFICER, {
    "Ar", "Artificer",
    4, 3, 5,
    { SP_STAR, SP_KOBOLD, SP_SPRIGGAN, SP_BASE_DRACONIAN, SP_DEMONSPAWN, },
    { },
...
{ JOB_CINDER_ACOLYTE, {
    "CA", "Cinder Acolyte",
    6, 6, 0,
    { SP_HILL_ORC, SP_BASE_DRACONIAN, SP_OGRE, SP_DJINNI, SP_GNOLL, SP_STAR },
    { SPELL_SCORCH },
    { "robe" },
    WCHOICE_PLAIN,
...
{ JOB_FIGHTER, {
    "Fi", "Fighter",
    8, 0, 4,
    { SP_STAR, SP_HILL_ORC, SP_TROLL, SP_MINOTAUR, SP_GARGOYLE,
      SP_PALENTONGA, },
    { },
...
{ JOB_MONK, {
    "Mo", "Monk",
    3, 2, 7,
    { SP_STAR, SP_HILL_ORC, SP_TROLL, SP_PALENTONGA, SP_MERFOLK,
...
{ JOB_WANDERER, {
    "Wn", "Wanderer",
    0, 0, 0, // Randomised
    { SP_HILL_ORC, SP_STAR, SP_GNOLL, SP_MERFOLK, SP_BASE_DRACONIAN,
...
{ JOB_WARPER, {
    "Wr", "Warper",
    3, 5, 4,
    { SP_FELID, SP_STAR, SP_SPRIGGAN, SP_PALENTONGA, SP_BASE_DRACONIAN, },
    {
        SPELL_BLINK,
        SPELL_BECKONING,
        SPELL_GRAVITAS,
